...
public class Inventory_management_system {
    ...
    private static int getMenuChoice(String menuText, int maxChoice) {
        while (true) {
    ...
    private static int mainMenu() {
        String mainMenu = "Inventory Management System\n"
                         ...
                         +"(3)Exit Program\n"
                         +"Enter Choice Index:";
        return getMenuChoice(mainMenu, 3);
    }
    ...
    private static void roleHandler(AdminRole role) {
        ...
        while (isConfirmation == 1) {
            choice = getMenuChoice(adminMenu, 4);
            switch (choice) {
                case 1://Add Employee
    ...
    private static void roleHandler(EmployeeRole role) {
        ...
        while (isConfirmation == 1) {
            ...
            choice = getMenuChoice(employeeMenu, 7);
